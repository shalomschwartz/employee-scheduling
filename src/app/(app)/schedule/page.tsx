  ...
  return (
    <div className="space-y-4">
      ...
      {loading ? (
        ...
        <>
          {/* Grid header with refresh */}
          <div className="flex items-center justify-between">
            <p className="text-xs text-gray-400">לחץ על שם עובד לעריכת זמינות</p>
            <button
              onClick={refreshSchedule}
              disabled={refreshing}
              className="flex items-center gap-1.5 text-xs text-gray-500 hover:text-gray-700 px-2 py-1 rounded-md hover:bg-gray-100 transition-colors disabled:opacity-50"
            >
              <svg
